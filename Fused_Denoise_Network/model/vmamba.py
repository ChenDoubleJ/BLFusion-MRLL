...
class ChannelAttention(nn.Module):
    ...
    def __init__(self, num_feat, squeeze_factor=8):
        ...
        # if num_feat < 16:
        #     squeeze_factor = squeeze_factor // 2
        # print(num_feat)
...
class CAB(nn.Module):
    def __init__(self, num_feat, is_light_sr= False, compress_ratio=3,squeeze_factor=8):
