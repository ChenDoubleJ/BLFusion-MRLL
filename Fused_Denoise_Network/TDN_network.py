...
class DecomNet(nn.Module):
    def __init__(self, inp_channel = 4, channel=32, kernel_size=3):
        ...
        # self.net2_convs = nn.Sequential(nn.Conv2d(channel, channel, 5, padding=2, padding_mode='replicate'),
        #                         nn.ReLU(),
        #                         nn.Conv2d(channel, channel, kernel_size, padding=1, padding_mode='replicate'),
        #                         nn.ReLU(),
        #                         nn.Conv2d(channel, channel, kernel_size, padding=1, padding_mode='replicate'),
        #                         nn.ReLU())
        # self.net2_recon = nn.Conv2d(channel, 1,  1, padding=0, padding_mode='replicate')

        self.TDN_R = TDN(dim=24)

    def forward(self, input_im):  # 4, H, W
